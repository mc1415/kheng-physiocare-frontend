...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const toastConfig = { duration: 3000, close: true, gravity: "top", position: "right", stopOnFocus: true };
    let allInvoices = [];
    const professionalServices = [ { name: "Physiotherapy Treatment", price: "20.00", isService: true }, { name: "Dry Needling Session", price: "45.00", isService: true }, { name: "Sports Massage (30 min)", price: "40.00", isService: true } ];
